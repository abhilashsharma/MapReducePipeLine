...
public class SnapToDriver {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		job1.setJarByClass(SnapToMetisMapper.class);
	    job1.setMapperClass(SnapToMetisMapper.class);

	    job1.setReducerClass(SnapToMetisReducer.class);
